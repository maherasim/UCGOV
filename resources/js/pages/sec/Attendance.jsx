...
/** Resizes/compresses a captured photo client-side before upload — mirrors the field-tested pattern from the reference attendance system. */
function compressPhoto(file, maxDimension = 640, quality = 0.72) {
    return new Promise((resolve, reject) => {
        const img = new Image();
