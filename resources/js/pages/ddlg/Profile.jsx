            ...
            <Card className="p-5">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div className="text-sm text-ink-muted">Deputy Director Local Government</div>
                    </div>
                </div>
                <dl className="mt-4 divide-y divide-border border-t border-border text-sm">
                    <div className="flex justify-between py-2">
                        <dt className="text-ink-muted">District</dt>
                        <dd className="font-medium text-ink">{user?.ddlg_profile?.district || '—'}</dd>
                    </div>
                    <div className="flex justify-between py-2">
                        <dt className="text-ink-muted">Grade</dt>
                        <dd className="font-medium text-ink">{user?.ddlg_profile?.grade || '—'}</dd>
                    </div>
                    <div className="flex justify-between py-2">
