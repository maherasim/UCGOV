...
export default function Attendance() {
    ...
    const attendance = useQuery({
        queryKey: ['ddlg-attendance', appliedFilters],
        queryFn: () =>
            client
                .get('/api/ddlg/attendance', {
                    params: {
    ...
    const movement = useQuery({
        queryKey: ['ddlg-movement-log'],
        queryFn: () => client.get('/api/ddlg/movement-log').then((r) => r.data.data),
    ...
    const exportUrl = () => {
        ...
        return `${APP_BASE_PATH}/api/ddlg/attendance/analytics-export${qs ? `?${qs}` : ''}`;
    };
        ...
        <div>
            <div className="mb-4 flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-ink-muted">Every secretary across your district — view only</p>
                </div>
                ...
                (movement.isLoading ? (
                    ...
                    <div>
                        <div className="mb-3 flex justify-end">
                            <Button variant="ghost" onClick={() => window.open(`${APP_BASE_PATH}/api/ddlg/movement-log/export`, '_blank')}>
                                📥 Export Excel
                            </Button>
                        </div>
                        <Card>
